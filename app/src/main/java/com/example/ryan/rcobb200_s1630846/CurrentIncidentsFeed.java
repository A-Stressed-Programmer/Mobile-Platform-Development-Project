...
//--//
public class CurrentIncidentsFeed extends AsyncTask {
    //-Private Variables-//
    ...
    protected Object doInBackground(Object[] objects) {
        //-Smoke Test Module-//
        System.out.println("CurrentIncidentsFeed.doInBackGround(AsyncTask): Process Started!");
        //-Main Try/Catch-//
        try{
        ...
        //-Smoke Test Module-//
        System.out.println("CurrentIncidentsFeed.doInBackGround(AsyncTask): Process Completed!");
        //-Return ArrayList-//
        return items;
    }
    ...
    //--Getter--//
    public ArrayList<String> getCurrentIncidentsData(){return items;}

    //-An Example-//
    public InputStream ExampleSmokeTestingDesign(InputStream TestingExample){
        //-Smoke Test Module-//
        System.out.println("CurrentIncidentsFeed.ExampleSmokeTestingDesign: Process Started!");

        //-Smoke Test Module-//
        System.out.println("CurrentIncidentsFeed.ExampleSmokeTestingDesign: Process Completed!");
        return null;
    }
